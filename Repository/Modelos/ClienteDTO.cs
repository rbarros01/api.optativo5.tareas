...
namespace Repository.Modelos
{
    public class ClienteDTO
    {
        ...
        [StringLength(100, MinimumLength = 3, ErrorMessage = "El nombre debe tener un mínimo de 3 caracteres.")]
        ...
        [StringLength(100, MinimumLength = 3, ErrorMessage = "El documento debe tener un mínimo de 3 caracteres.")]
